                ...
                container()
                    ...
                    .child(
                        card()
                            ...
                            .child(
                                container().child(text("This is a card with static content.").color(Color::rgb(0.8, 0.8, 0.8))),
                            )
                            .child(
                                container().child(text("Cards can have multiple children.").color(Color::rgb(0.8, 0.8, 0.8))),
                            ),
                    )
                    .child(

...
fn panel(caption: &'static str, styled: Text) -> Container {
    container()
            ...
            container()
                ...
                .child(
                    container()
                        ...
                        .child(styled.font_size(52.0).color(Color::WHITE).nowrap()),
                ),
        )
        .child(
            container().child(
...
fn main() {
    ...
    App::new().run(|app| {
        let view = container()
            ...
            .child(panel("nothing", text(LABEL)))
            .child(panel(
                "stroke 1.5",
                text(LABEL).text_stroke(TextStroke::new(1.5, Color::BLACK)),
            ))
            .child(panel(
                "shadow 0,2 blur 10",
                text(LABEL).text_shadow(TextShadow::new(
                    0.0,
                    2.0,
                    10.0,
